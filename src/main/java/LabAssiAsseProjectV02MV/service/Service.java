package LabAssiAsseProjectV02MV.service;


import LabAssiAsseProjectV02MV.curent.Curent;
...
public class Service {
    ...
    public double addNota(Nota nota, String feedback){
        ...
        if(predare > tema.getDeadline()){ // modified the condition to support assignments before the deadline
